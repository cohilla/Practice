...
using AllOf_List_Signature = function<bool (list<int>::iterator, list<int>::iterator, function<bool (int)>)>;
...
INSTANTIATE_TEST_CASE_P(
    ...
    AllOf_List_Fixture,
    Values(
           all_of<list<int>::iterator, function<bool (int)>>,
        my_all_of<list<int>::iterator, function<bool (int)>>));
